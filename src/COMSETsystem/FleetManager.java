...
public abstract class FleetManager {
    ...
    public abstract AgentAction onResourceAvailabilityChange(Resource resource, ResourceState state, DistanceLocationOnLink currentLoc, long time);

    public abstract Intersection onReachIntersection(long agentId, long time, DistanceLocationOnLink currentLoc);

    public abstract Intersection onReachIntersectionWithResource(long agentId, long time, DistanceLocationOnLink currentLoc, Resource resource);
